...
- to simplify Ajv extensions, the new keyword API that is used by all included keywords is available to user-defined keywords - it is much easier to define any keywords now, especially with subschemas.
